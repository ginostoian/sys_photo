...
const Hero = () => {
  ...
  return (
    <section className="max-w-[95%] sm:max-w-[85%] mx-auto bg-slate-200 rounded-3xl mt-10 flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-20 px-8 py-8 lg:py-20">
